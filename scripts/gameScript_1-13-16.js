...
$(document).ready(function() {
    ...
    function naming(){
       ...
       $('<p></p>').appendTo($("#instructions")).typed({ strings : [filter_text_options_out(newInstruction)], typeSpeed : 10, startDelay: 2000, callback : function() {
   ...
   /*function skipToInstructions(newInstruction, callback) {
       $("#buttonOptions").hide();
       $("#skipType").show();
       startScrollPageDownLoop();
       $('<p></p>').appendTo($("#instructions")), callback : function() {
           endScrollPageDownLoop();
           callback && callback();
           options(newInstruction)
       }});
...
// delayOptions completely.
   ...
   function revealOptions(progress, delayTime = 500, typeSpeed) {
  ...
  //  }
    ...
    function firstchoice() {
        ...
        if (localStorage.getItem('num') == '0') {
            revealOptions(firstchoice, 33000);
        } else{
